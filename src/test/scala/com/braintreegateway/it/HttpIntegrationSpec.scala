...
import com.braintreegateway.{CustomerRequest, Environment}
import com.braintreegateway.exceptions.{DownForMaintenanceException, UpgradeRequiredException, AuthenticationException}
